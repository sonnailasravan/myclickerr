...
<Container>
  ...
  <div className="myBooking">
    ...
    <div>
     <Image
        ...
        height={16.72}
      />
      <h6>Chitrapuri colony, Manikonda, Puppalaguda, Ranga reddy, Hyderabad - 500089</h6>
     </div>
  ...
  <div className="myBooking_2">
   ...
   <label>  Booked on 16 June, 2022 - 08:30AM</label>
    ...
    {/*--------------------- 2nd line card-------------------- */}
<Container>
  <div><h6>Previous Bookings</h6></div>
  ...
  <div className="myBooking_3">
    ...
    <div>
     ...
     <div>
      <label>Total price</label>
      <h6 className="r3 mb-1 mt-2"><span>&#8377;</span> 1000 <i>Per Hour</i>    </h6>                  
     </div>
