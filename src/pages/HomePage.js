        ...
        <Carousel fade>
          ...
          <Carousel.Item className={style.CaroselContainer}>
            ...
            <section className="innerCard">
              ...
              <div>
                <label>
                  New text comes here all with their own unique style and
                  portfolio of work. It was incredibly helpful to be able to see
                  examples of their work before booking them for a shoot.
                </label>
              </div>
            </section>
          </Carousel.Item>
